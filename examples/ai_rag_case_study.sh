...
WORK="${TMPDIR:-/tmp}/orbeliasdb-ai-rag-case-$$"
...
nim c -d:release --nimcache:/tmp/nimcache_orbelias_ai_rag_case -o:bin/ai_rag_case_study examples/ai_rag_case_study.nim

echo
echo "== Run OrbeliasDB AI/RAG case study =="
