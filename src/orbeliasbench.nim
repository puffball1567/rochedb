## orbeliasbench - mechanism benchmark
##
## Measures OrbeliasDB mechanism costs: location resolution, reads/writes, and
...
##
## build: nim c -d:danger -o:bin/orbeliasbench src/orbeliasbench.nim
