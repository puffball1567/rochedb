## rochebench - mechanism benchmark
##
## Measures RocheDB mechanism costs: location resolution, reads/writes, and
...
##
## build: nim c -d:danger -o:bin/rochebench src/rochebench.nim
