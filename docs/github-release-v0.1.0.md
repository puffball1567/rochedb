...
KoutenDB v0.1.0 is the first public technical preview of a ring/galaxy-oriented
...
for this release is narrower: KoutenDB can route reads through explicit rings and
...
- `kouten doctor` for the FAISS bridge
