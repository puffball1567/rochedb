...
suite "driver wire protocol":
  test "PUTR/GETID/QRYID hide ring internals from external drivers":
    let peers = getEnv("ORBELIAS_TEST_PEERS", "127.0.0.1:17631,127.0.0.1:17632")
